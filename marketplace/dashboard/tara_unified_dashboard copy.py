...
# -*- coding: utf-8 -*-
"""Tara Unified Dashboard with Backend Sync"""
...
# --- Initialize Agents from Backend or fallback ---
if 'tara_agents_df' not in st.session_state:
    agents = fetch_agents()
    if agents:
        # Normalize keys to title case with spaces for DataFrame columns
        # Assuming backend returns keys like 'agent_id', 'weekly_earnings', etc.
        ...
        # Add Monetizing column default False
...
with tab2:
    ...
    # Safe daily earnings calc if Weekly Earnings column exists
