...
SHOPIFY_STORE_URL = os.getenv("SHOPIFY_STORE_URL", "https://tarasupp.myshopify.com")
...
def check_shopify_credentials():
    ...
    if not SHOPIFY_ACCESS_TOKEN:
        print("Missing Shopify access token. Please set SHOPIFY_ACCESS_TOKEN as an environment variable.")
        return
